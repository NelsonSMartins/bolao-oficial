...
const USUARIOS = {
    ...
    'Douglas': { senha: 'a1b2c3d4', role: 'user', nome: 'User 01' },
    'Alexandre': { senha: 'e5f6g7h8', role: 'user', nome: 'User 02' },
    'Alcy': { senha: 'i9j0k1l2', role: 'user', nome: 'User 03' },
    'Carla': { senha: 'm3n4o5p6', role: 'user', nome: 'User 04' },
    'Thiago': { senha: 'q7r8s9t0', role: 'user', nome: 'User 05' },
    'Ronaldo': { senha: 'u1v2w3x4', role: 'user', nome: 'User 06' },
    'Kelly': { senha: 'y5z6a7b8', role: 'user', nome: 'User 07' },
    'Ana': { senha: 'c9d0e1f2', role: 'user', nome: 'User 08' },
    'Carmem': { senha: 'g3h4i5j6', role: 'user', nome: 'User 09' },
    'Rogéria': { senha: 'k7l8m9n0', role: 'user', nome: 'User 10' },
    'Carol': { senha: 'o1p2q3r4', role: 'user', nome: 'User 11' },
    'Nelson': { senha: 's5t6u7v8', role: 'user', nome: 'User 12' },
    'Márcio': { senha: 'w9x0y1z2', role: 'user', nome: 'User 13' },
    'Raphael': { senha: 'a3b4c5d6', role: 'user', nome: 'User 14' },
    'Julio': { senha: 'e7f8g9h0', role: 'user', nome: 'User 15' },
    'Elyseu': { senha: 'i1j2k3l4', role: 'user', nome: 'User 16' },
