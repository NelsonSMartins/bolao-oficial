...
const USUARIOS = {
    ...
    'user01': { senha: 'a1b2c3d4', role: 'user', nome: 'User 01' },
    'user02': { senha: 'e5f6g7h8', role: 'user', nome: 'User 02' },
    'user03': { senha: 'i9j0k1l2', role: 'user', nome: 'User 03' },
    'user04': { senha: 'm3n4o5p6', role: 'user', nome: 'User 04' },
    'user05': { senha: 'q7r8s9t0', role: 'user', nome: 'User 05' },
    'user06': { senha: 'u1v2w3x4', role: 'user', nome: 'User 06' },
    'user07': { senha: 'y5z6a7b8', role: 'user', nome: 'User 07' },
    'user08': { senha: 'c9d0e1f2', role: 'user', nome: 'User 08' },
    'user09': { senha: 'g3h4i5j6', role: 'user', nome: 'User 09' },
    'user10': { senha: 'k7l8m9n0', role: 'user', nome: 'User 10' },
    'user11': { senha: 'o1p2q3r4', role: 'user', nome: 'User 11' },
    'user12': { senha: 's5t6u7v8', role: 'user', nome: 'User 12' },
    'user13': { senha: 'w9x0y1z2', role: 'user', nome: 'User 13' },
    'user14': { senha: 'a3b4c5d6', role: 'user', nome: 'User 14' },
    'user15': { senha: 'e7f8g9h0', role: 'user', nome: 'User 15' },
    'user16': { senha: 'i1j2k3l4', role: 'user', nome: 'User 16' },
